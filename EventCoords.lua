-- Most random event coordinates are stored in UGC files, which can be found at update/update2.rpf/common/data/ugc directory.
-- Some event coords are either in freemode or its own script.
...
function bank_shootout_coordinates(location)
	if location == 0 then return vec3:new(-890.265, -436.314, 167.119) end
